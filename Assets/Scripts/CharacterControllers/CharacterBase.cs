...
public abstract class CharacterBase : MonoBehaviour {
    ...
    [HideInInspector]
    public OriginalState os;
    [HideInInspector]
    public SkillBase sb;
    [HideInInspector]
    public SoundContainer sc;
    ...
    public virtual void Start() {
        ...
        sc = GetComponent<SoundContainer>();
    ...
    public virtual void SelectState() {
        switch (state) {
            ...
            case State.die:
                dying = true;
                if(sc.Die != null)
                    SoundManager.instance.PlaySound_Voice(sc.Die);
                Invoke("die", 0.7f);
    ...
    public virtual void attack() {
        ...
        SoundManager.instance.PlaySound_Sfx(sc.attack);
    }
